...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( in_array( 'menu__item--current', $classes, true ) || in_array( 'current-menu-parent', $classes, true ) ) {
				$classes[] = 'active-dropdown-menu';
			}
			...
			$output .= $indent . '<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement"' . $id . $class_names . ' menu__item>';
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				...
				$atts['class']         = 'menu-item__parent menu-level-1 nav-link menu__link';
